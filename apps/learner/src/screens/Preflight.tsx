    ...
    <View style={[styles.root, t.root]}>
      ...
      >
        <Pressable onPress={onBack} hitSlop={12} style={{ marginBottom: 16 }}>
          <Text style={[styles.rowDetail, t.muted]}>‹ Back</Text>
        </Pressable>
        <Text style={[styles.title, t.title]}>This build</Text>
        <Text style={[styles.subtitle, t.muted]}>
          Whether the pieces the capture path needs are actually here.
        </Text>
